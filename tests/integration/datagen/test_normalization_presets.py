...
normalization path (config-generated normalizer, the messages -> conversations
...
from speculators.data_generation.configs import DatasetConfig, resolve_normalize_fn
...
def test_normalization_produces_valid_conversations(name: str):
    ...
    normalize_fn = resolve_normalize_fn(config)
